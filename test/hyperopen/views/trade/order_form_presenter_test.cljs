(ns hyperopen.views.trade.order-form-presenter-test
...
(deftest format-fees-supports-structured-and-legacy-shapes-test
  (let [structured (presenter/format-fees {:effective {:taker 0.045
                                                       :maker 0.015}
                                           :baseline {:taker 0.05
                                                      :maker 0.02}})
        legacy (presenter/format-fees {:taker 0.045
                                       :maker 0.015})
        missing (presenter/format-fees nil)]
...
(deftest summary-display-formats-fees-as-structured-display-model-test
  (let [display (presenter/summary-display {:available-to-trade 0
