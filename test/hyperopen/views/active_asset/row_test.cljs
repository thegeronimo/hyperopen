  ...
  (support/with-viewport-width
    ...
    (fn []
      (let [market {:coin "#0"
        ...
        (is (support/contains-class? view-node "right-3"))
        (is (support/contains-class? view-node "shadow-[0_-8px_26px_rgba(45,212,191,0.10),0_18px_70px_rgba(0,0,0,0.55)]"))
        (is (support/contains-class? view-node "group-hover/outcome-name:border-[#2dd4bf]/55"))
