...
- Observation: `OCP-01` retired `/hyperopen/src/hyperopen/schema/runtime_registration_catalog.cljs` as a hotspot, so the remaining runtime-hub edit-fanout is now concentrated in `runtime/collaborators.cljs`, `runtime/action_adapters.cljs`, and `schema/contracts.cljs`.
  Evidence: `wc -l` on 2026-03-25 reported 414 lines for `/hyperopen/src/hyperopen/runtime/collaborators.cljs`, 376 for `/hyperopen/src/hyperopen/runtime/action_adapters.cljs`, 99 for `/hyperopen/src/hyperopen/schema/runtime_registration_catalog.cljs`, and 998 for `/hyperopen/src/hyperopen/schema/contracts.cljs`.
