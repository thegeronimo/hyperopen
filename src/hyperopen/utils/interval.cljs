...
(defmethod interval-to-milliseconds :3m [_] (* 3 (interval-to-milliseconds :1m)))
...
(defmethod interval-to-milliseconds :30m [_] (* 30 (interval-to-milliseconds :1m)))
(defmethod interval-to-milliseconds :1h [_] (* 60 (interval-to-milliseconds :1m)))
(defmethod interval-to-milliseconds :2h [_] (* 2 (interval-to-milliseconds :1h)))
(defmethod interval-to-milliseconds :4h [_] (* 4 (interval-to-milliseconds :1h)))
(defmethod interval-to-milliseconds :8h [_] (* 8 (interval-to-milliseconds :1h)))
(defmethod interval-to-milliseconds :12h [_] (* 12 (interval-to-milliseconds :1h)))
