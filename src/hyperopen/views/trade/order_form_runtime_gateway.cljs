...
(def ^:private action-id-by-command-id
  {:order-form/select-entry-mode :actions/select-order-entry-mode
   ...
   :order-form/toggle-tpsl-unit-dropdown :actions/toggle-tpsl-unit-dropdown
   :order-form/close-tpsl-unit-dropdown :actions/close-tpsl-unit-dropdown
   :order-form/handle-tpsl-unit-dropdown-keydown :actions/handle-tpsl-unit-dropdown-keydown
