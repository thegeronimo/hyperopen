...
(defn- runtime-effect-overrides
  ...
  {:save effect-adapters/save
   ...
   :queue-asset-icon-status effect-adapters/queue-asset-icon-status
   ...
   :api-submit-order effect-adapters/api-submit-order
   :api-cancel-order effect-adapters/api-cancel-order
