...
def policyCorpus : List (String × Policy) :=
  ...
  ,("actions/end-portfolio-summary-custom-range-drag", defaultPolicy true ["effects/api-fetch-trader-portfolio-benchmark", "effects/fetch-candle-snapshot"])
  ,("actions/open-portfolio-summary-custom-range", defaultPolicy true ["effects/api-fetch-trader-portfolio-benchmark", "effects/fetch-candle-snapshot"])
  ...
  ,("actions/end-vault-detail-custom-range-drag", defaultPolicy true ["effects/fetch-candle-snapshot"])
  ,("actions/open-vault-detail-custom-range", defaultPolicy true ["effects/fetch-candle-snapshot"])
